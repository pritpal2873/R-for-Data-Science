...
**The greatest value of a picture is when it forces us to notice what we never expected to see ___ John Tukey**
...
```
We will need to pick a value that makes sense for that aesthetic.
